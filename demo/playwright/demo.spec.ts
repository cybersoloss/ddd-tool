  ...
  test('full navigation demo', async ({ page }) => {
    ...
    await page.setContent(renderTerminal({
      ...
      lines: [
        ...
        '  {dim}designing and executing an AI agent with the{/dim}',
        '  {dim}DDD methodology.{/dim}',
        '',
        '  {dim}This is a deliberately brief overview showing how{/dim}',
        '  {dim}DDD Tool lets you visually design agent flows —{/dim}',
        '  {dim}from system-level domain mapping down to individual{/dim}',
        '  {dim}node specifications.{/dim}',
        '',
