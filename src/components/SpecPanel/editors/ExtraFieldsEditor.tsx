...
const KNOWN_KEYS: Record<DddNodeType, Set<string>> = {
  trigger: new Set(['event', 'source', 'filter', 'description', 'job_config', 'pattern', 'debounce_ms', 'rate_limit', 'signature', 'connection_config', 'tier_limits']),
  ...
  data_store: new Set(['store_type', 'operation', 'model', 'data', 'query', 'description', 'pagination', 'sort', 'batch', 'upsert_key', 'include', 'returning', 'path', 'content', 'create_parents', 'store', 'selector', 'safety', 'predicate', 'patch', 'aggregate_fields', 'group_by', 'filters']),
  service_call: new Set(['method', 'url', 'headers', 'body', 'timeout_ms', 'retry', 'error_mapping', 'description', 'request_config', 'integration', 'oauth_config', 'oauth1a_config', 'capture_headers', 'fallback']),
  ipc_call: new Set(['command', 'args', 'return_type', 'timeout_ms', 'bridge', 'result_condition', 'description']),
  event: new Set(['direction', 'event_name', 'payload', 'payload_source', 'async', 'description', 'target_queue', 'priority', 'delay_ms', 'dedup_key', 'correlation_id']),
  loop: new Set(['collection', 'iterator', 'break_condition', 'on_error', 'accumulate', 'description', 'body_start']),
  parallel: new Set(['branches', 'join', 'join_count', 'timeout_ms', 'description', 'failure_policy', 'merge_strategy']),
  ...
  cache: new Set(['key', 'ttl_ms', 'store', 'description', 'operation', 'value', 'ttl_jitter_ms']),
  transform: new Set(['input_schema', 'output_schema', 'field_mappings', 'description', 'mode']),
  collection: new Set(['operation', 'input', 'predicate', 'key', 'direction', 'accumulator', 'output', 'description', 'count', 'right', 'on', 'join_type']),
  parse: new Set(['format', 'input', 'strategy', 'library', 'output', 'description']),
  crypto: new Set(['operation', 'algorithm', 'key_source', 'input_fields', 'output_field', 'encoding', 'description', 'length']),
