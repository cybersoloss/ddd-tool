...
const KNOWN_KEYS: Record<DddNodeType, Set<string>> = {
  ...
  data_store: new Set(['store_type', 'operation', 'model', 'data', 'query', 'description', 'pagination', 'sort', 'batch', 'upsert_key', 'include', 'returning', 'path', 'content', 'create_parents', 'store', 'selector', 'safety', 'predicate', 'patch']),
