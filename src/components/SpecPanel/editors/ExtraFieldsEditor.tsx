...
const KNOWN_KEYS: Record<DddNodeType, Set<string>> = {
  ...
  data_store: new Set(['store_type', 'operation', 'model', 'data', 'query', 'description', 'pagination', 'sort', 'batch', 'upsert_key', 'include', 'returning', 'path', 'content', 'create_parents', 'store', 'selector', 'safety']),
  service_call: new Set(['method', 'url', 'headers', 'body', 'timeout_ms', 'retry', 'error_mapping', 'description', 'request_config', 'integration']),
  ipc_call: new Set(['command', 'args', 'return_type', 'timeout_ms', 'bridge', 'description']),
