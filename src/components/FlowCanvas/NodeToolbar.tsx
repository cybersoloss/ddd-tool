...
const TRADITIONAL_ITEMS: ToolbarItem[] = [
  ...
  { type: 'text_split', label: 'Text Split', icon: Scissors, borderColor: 'border-l-lime-500', iconColor: 'text-lime-400' },
